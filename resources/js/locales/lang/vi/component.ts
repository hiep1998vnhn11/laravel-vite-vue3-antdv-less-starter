export default {
  ...
  table: {
    settingDens: 'Khoảng cách giữa các dòng',
    settingDensDefault: 'Mặc định',
    settingDensMiddle: 'Trung bình',
    settingDensSmall: 'Thu nhỏ',
    settingColumn: 'Cài đặt cột',
    settingColumnShow: 'Hiển thị cột',
    settingIndexColumnShow: 'Cột chỉ mục',
    settingSelectColumnShow: 'Chọn cột',
    settingFixedLeft: 'Ghim trái',
    settingFixedRight: 'Ghim phải',
    settingFullScreen: 'Toàn màn hình',
    index: '#',
    total: 'Tổng cộng {total} kết quả',
  },
  time: {
    before: ' trước',
    after: ' sau',
