...
const getters = {
    ...
    getBeforeMiniInfo: (state: AppState): BeforeMiniState =>
        state.beforeMiniInfo,
    getProjectConfig: (state: AppState): ProjectConfig =>
        state.projectConfig || ({} as ProjectConfig),
    getHeaderSetting: (state: AppState): HeaderSetting =>
        state.projectConfig.headerSetting,
    getMenuSetting: (state: AppState): MenuSetting =>
        state.projectConfig.menuSetting,
    getTransitionSetting: (state: AppState): TransitionSetting =>
        state.projectConfig.transitionSetting,
    getMultiTabsSetting: (state: AppState): MultiTabsSetting =>
        state.projectConfig.multiTabsSetting,
}
const actions = {
    async resetAllState() {
        resetRouter()
...
const mutations = {
    ...
    SET_BEFORE_MINI_INFO: function (
        state: AppState,
        beforeState: BeforeMiniState
    ) {
        state.beforeMiniInfo = beforeState
    },
    SET_PROJECT_CONFIG: function (
        state: AppState,
