                    ...
                    :class="[
                        {
                            ...
                            [`${prefixCls}-submenu-collapsed-show-tit`]:
                                collapsedShowTitle,
                        },
                    ]"
                >
        ...
        const getSubClass = computed(() => {
            ...
            return [
                `${prefixCls}-submenu-title`,
                {
                    ...
                    [`${prefixCls}-submenu-active-border`]:
                        isActive && level === 0,
                    [`${prefixCls}-submenu-collapse`]:
                        unref(getCollapse) && level === 0,
                },
            ]
        })
            ...
            rootMenuEmitter.on(
                ...
                (data: boolean | (string | number)[] | Recordable) => {
                    ...
                    if (props.name && Array.isArray(data)) {
                        state.opened = (data as (string | number)[]).includes(
                            props.name
                        )
                    }
                }
