...
export default defineComponent({
    ...
    setup(props, { slots }) {
        ...
        function handleRules(): ValidationRule[] {
            ...
            let rules: ValidationRule[] = cloneDeep(
                defRules
            ) as ValidationRule[]
            ...
            if (requiredRuleIndex !== -1) {
                ...
                if (component) {
                    if (!Reflect.has(rule, 'type')) {
                        rule.type =
                            component === 'InputNumber' ? 'number' : 'string'
                    }
        ...
        function renderComponent() {
            ...
            const isCheck =
                component && ['Switch', 'Checkbox'].includes(component)
            ...
            const isCreatePlaceholder =
                !propsData.disabled && autoSetPlaceHolder
            ...
            const bindValue: Recordable = {
                [valueField || (isCheck ? 'checked' : 'value')]:
        ...
        function renderLabelHelpMessage() {
            const { label, helpMessage, helpComponentProps, subLabel } =
                props.schema
