<template>
    <Header :class="getHeaderClass">
        ...
        <!-- action  -->
        <div :class="`${prefixCls}-action`" style="margin-right: 20px">
            <ErrorAction
            ...
            <AppLocalePicker
                v-if="false && getShowLocalePicker"
                :reload="true"
                :showText="false"
                :class="`${prefixCls}-action__item`"
            />
...
import { AppSearch, AppSearchInput } from '/@/components/Application'
    ...
    setup(props) {
        ...
        const getSplitType = computed(() => {
            return unref(getSplit)
                ? MenuSplitTyeEnum.TOP
                : MenuSplitTyeEnum.NONE
        })
