...
export function useTabs(_router?: Router) {
    ...
    function getCurrentTab() {
        ...
        return store.getters['multipleTab/getTabList'].find(
    ...
    async function updateTabTitle(
        ...
        await store.commit('multipleTab/SET_TAB_TITLE', {
            title,
            route: targetTab,
        })
    }
    ...
    async function handleTabAction(
        ...
        switch (action) {
            ...
            case TableActionEnum.CLOSE_LEFT:
                await store.dispatch('multipleTab/closeLeftTabs', {
                    tab: currentTab,
                    router,
                })
                break
            ...
            case TableActionEnum.CLOSE_RIGHT:
                await store.dispatch('multipleTab/closeRightTabs', {
                    tab: currentTab,
                    router,
                })
                break
            ...
            case TableActionEnum.CLOSE_OTHER:
                await store.dispatch('multipleTab/closeOtherTabs', {
                    tab: currentTab,
                    router,
                })
                break
            ...
            case TableActionEnum.CLOSE:
                await store.dispatch('multipleTab/closeTab', {
                    tab: tab || currentTab,
                    router,
                })
                break
