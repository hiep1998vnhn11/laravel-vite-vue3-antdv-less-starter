...
export function useRootSetting() {
    ...
    const getOpenKeepAlive = computed(
        () => store.getters['app/getProjectConfig'].openKeepAlive
    )
    ...
    const getShowLogo = computed(
        () => store.getters['app/getProjectConfig'].showLogo
    )

    const getContentMode = computed(
        () => store.getters['app/getProjectConfig'].contentMode
    )

    const getUseOpenBackTop = computed(
        () => store.getters['app/getProjectConfig'].useOpenBackTop
    )
    ...
    const getUseErrorHandle = computed(
        () => store.getters['app/getProjectConfig'].useErrorHandle
    )

    const getShowFooter = computed(
        () => store.getters['app/getProjectConfig'].showFooter
    )

    const getShowBreadCrumb = computed(
        () => store.getters['app/getProjectConfig'].showBreadCrumb
    )

    const getThemeColor = computed(
        () => store.getters['app/getProjectConfig'].themeColor
    )
    ...
    const getFullContent = computed(
        () => store.getters['app/getProjectConfig'].fullContent
    )

    const getColorWeak = computed(
        () => store.getters['app/getProjectConfig'].colorWeak
    )

    const getGrayMode = computed(
        () => store.getters['app/getProjectConfig'].grayMode
    )

    const getLockTime = computed(
        () => store.getters['app/getProjectConfig'].lockTime
    )
